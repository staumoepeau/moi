						...
						<div className="kt-grid">
							{services.map((s) => (
								...
								>
									...
									<span className="kt-service-label" style={{ fontWeight: 700, marginBottom: 6, marginTop: 20 }}>{s.name}</span>
									{s.service_items && s.service_items.length > 0 && (
										<div style={{ fontSize: 14, textAlign: "left", flex: 1, overflow: "hidden" }}>
